...
<div class="parent-body">
    ...
    @if(count($viewData['orders']['own']) > 0)
        ...
        <table class="orderTable" style="margin-left: 0">
            ...
            <!--header-->
            <tr>
                @if($viewData['userSubdomain'] && $viewData['userSubdomain']['settings'] && !empty($viewData['userSubdomain']['settings']['contractsIds']))
                    <th>id</th>
                @endif
            ...
            @foreach($viewData['orders']['own'] as $myOrderKey => $myOrder)
                ...
                <tr>
                    ...
                    <!--Consumo-->
                    <td class="text-center ellipsis" style="width: auto; padding: 5px 15px">{{ floor(doubleval($myOrder['consumption'])) }}</td>
                    <td class="text-center ellipsis" style="width: auto; padding: 5px 15px">{{ ($lastStatus['code'] === 'b' || $lastStatus['code'] === 'pendiente_de_retrocomisin') ? '-' : '' }}{{ ($lastStatus['code'] === 'b' || $lastStatus['code'] === 'pendiente_de_retrocomisin') ? $myOrder['salesDecommision'] : $myOrder['salesCommision'] }}</td>
                    <!--<td class="text-center ellipsis" style="width: 80px; padding: 5px 15px">/*$lastStatus['code'] === 'b' ? '-' : ''}}$lastStatus['code'] === 'b' ? $myOrder['asercordDecommision'] : $myOrder['asercordCommision']}}*/</td>-->
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td class="text-center ellipsis" style="width: auto; padding: 5px 15px; font-weight: bold;">{{ $viewData['totalCommision']['own'] }}</td>
                <!--<td class="text-center ellipsis" style="width: 80px; padding: 5px 15px; font-weight: bold;">{{ $viewData['totalAsercordCommision']['own'] }}</td>-->
            </tr>
        </table>
            ...
            <table style="margin-left: 0">
                ...
                @foreach($agentOrders as $orderKey => $order)
                    ...
                    <tr>
                        ...
                        <!--Consumo-->
                        <td class="text-center ellipsis" style="width: auto; padding: 5px 15px">{{ floor(doubleval($order['consumption'])) }}</td>
                        <td class="text-center ellipsis" style="width: auto; padding: 5px 15px">{{ ($lastStatus['code'] === 'b' || $lastStatus['code'] === 'pendiente_de_retrocomisin') ? '-' : '' }}{{ ($lastStatus['code'] === 'b' || $lastStatus['code'] === 'pendiente_de_retrocomisin') ? ($order['salesDecommision'] ?? '') : ($order['salesCommision'] ?? '') }}</td>
                        <!--<td class="text-center ellipsis" style="width: 80px; padding: 5px 15px"> /*$lastStatus['code'] === 'b' ? '-' : ''}} $lastStatus['code'] === 'b' ? (isset($order['asercordDecommision']) ? $order['asercordDecommision'] : 0) : (isset($order['asercordCommision']) ? $order['asercordCommision'] : 0)}}*/ </td>-->
                    </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td class="text-center ellipsis" style="width: auto; padding: 5px 15px; font-weight: bold;">{{ $viewData['totalCommision']['others'][$agent] }}</td>
                    <!--<td class="text-center ellipsis" style="width: 80px; padding: 5px 15px; font-weight: bold;">{{$viewData['totalAsercordCommision']['others'][$agent]}}</td>-->
                </tr>
            </table>
        @endif
    @endforeach
    ...
    <table class="no-Borders" style="width: 50%; margin-top: 25px">
        <tr>
            ...
            <td style="font-size: 25px; font-weight: 900">{{ $viewData['totalCommision']['global'] }}€</td>
        </tr>
    </table>
    ...
    <!--<table class="no-Borders" style="width: 50%; margin-top: 25px">
        <tr>
            ...
            <td style="font-size: 25px; font-weight: 900">{{ $viewData['totalAsercordCommision']['global'] }}€</td>
        </tr>
    </table>-->
</div>
</body>
