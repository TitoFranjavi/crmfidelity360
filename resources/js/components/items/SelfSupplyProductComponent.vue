            ...
            <div class="d-flex mt-10 mb-25 align-center f-wrap">
                ...
                <div class="d-flex align-center mr-50">
                    ...
                    <div class="d-flex align-center text ml-20" data-size="20" data-weight="700" v-on:click.stop="">
                        ...
                        <div class="d-flex">
                            <i class="fa-regular fa-solar-panel ml-10 mr-5 my-auto"></i>
...
export default {
    name: "SelfSupplyDetailsComponent",
    ...
    methods: {
        async fetchMarketer() {
            try {
                ...
                const products = this.marketer?.products?.selfSupply || [];
        ...
        async addProductFee() {
            ...
            this.marketer.products.selfSupply[this.productSelect].fees.push(newFee);

            //Ordeno
            this.marketer.products.selfSupply[this.productSelect].fees.sort((a, b) => {
                const feeA = a?.name || "";
                const feeB = b?.name || "";
        ...
        deleteProductFee(fee) {
            const list = this.marketer?.products?.selfSupply || [];
        ...
        async saveProd() {
            ...
            try {
                ...
                if (pIdx !== -1)
                    this.marketer.products.selfSupply.splice(pIdx, 1, productClean);
                else
                    this.marketer.products.selfSupply.push(productClean);
    ...
    computed:{
        filteredFeesToAdd() {
            ...
            return this.$storage.FEES.selfSupply.filter((feeNow) => {
        ...
        extraProductsToSelect() {
            ...
            return this.marketer.extras.filter(extra => extra.productTypes.includes('a') && extra.to.product && (!this.product.fees[this.feeSelect].extras || !this.product.fees[this.feeSelect].extras.includes(extra.id.$oid)))
        },
