<template>
    <div class="content-white">
        ...
        <form v-on:submit.prevent="createTask" class="form register-pos">
            ...
            <div class="top-part">
                ...
                <div class="inputs-part">
                    ...
                    <div v-bind:class="{ wrong: errors.subject}" class="form-group">
                        ...
                        <div class="input-group">
                            <input v-on:focus="delete errors['subject']" data-size="12" v-model="task.subject" type="text">
                        </div>
                    ...
                    <div v-bind:class="{ wrong: errors.desc}" class="form-group">
                        ...
                        <div class="input-group">
                            <input v-on:focus="delete errors['desc']" data-size="12" v-model="task.desc" type="text">
                        </div>
                    ...
                    <div class="half-space">
                        ...
                        <div v-bind:class="{ wrong: errors.priority}" class="form-group">
                            ...
                            <div class="input-group">
                                <select v-on:change="delete errors['priority']" v-model="task.priority">
                        ...
                        <div v-bind:class="{ wrong: errors.status}" class="form-group">
                            <label>Estado</label>
                            <div class="input-group">
                                <select v-on:change="delete errors['status']" v-model="task.status">
                    ...
                    <div v-bind:class="{ wrong: errors.finalDate}" class="form-group">
                        ...
                        <div class="input-group">
                            <input v-on:focus="delete errors['finalDate']" data-size="12" v-model="task.finalDate" type="datetime-local">
                        </div>
                ...
                <div class="inputs-part">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="custom-button ml-auto my-auto mr-20" data-size="medium" data-bg="amarillo" v-on:click="addSubTask"><i class="fas fa-plus"></i></div>
                    </div>
                    ...
                    <div class="mt-30">
                        <sub-task-component v-for="(subTask , subTaskInd) in task.subTasks" :subTask="subTask" :subTaskInd="subTaskInd" :errors="errors" @deleteSubTask="deleteSubTask"></sub-task-component>
                    </div>
            ...
            <div class="btn-part">
                ...
                <button class="custom-button" data-size="regular" v-if="!isReadOnly">Guardar <i class="fas fa-chevron-right ml-10"></i></button>
            </div>
...
export default {
    ...
    methods:{
        async fetchUserContacts(){
            ...
            await axios.post(`/api/contacts/indexWithoutPagination/${this.basicData.userLogged._id}`, { userList: JSON.stringify(this.basicData.userList) })
                .then((res) => {
        ...
        async fetchUserAccounts(){
            ...
            await axios.post(`/api/accounts/indexWithoutPagination/${this.basicData.userLogged._id}`,{userList: JSON.stringify(this.basicData.userList)})
                .then((res) => {
        ...
        createTask(){
            ...
            if (!hasErrors){
                ...
                axios.post(`/api/tasks`, { task: this.task})
                    .then((res) => {
                        Swal.fire({
                            icon: "success",
                            title: "Tarea creada",
